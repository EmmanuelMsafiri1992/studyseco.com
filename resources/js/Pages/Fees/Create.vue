    ...
    <div class="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50 font-sans text-slate-800">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="h-20 bg-white/70 backdrop-blur-xl border-b border-slate-200/50 px-8 flex items-center justify-between relative z-50">
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">Add New Fee</h1>
                    <p class="text-slate-500 text-sm">Enter fee details below</p>
                </div>
                    ...
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input v-model="form.studentId" type="text" class="mt-1 block w-full bg-slate-100/70 px-4 py-3 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700">Amount</label>
                                <input v-model="form.amount" type="number" class="mt-1 block w-full bg-slate-100/70 px-4 py-3 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700">Due Date</label>
                                <input v-model="form.dueDate" type="date" class="mt-1 block w-full bg-slate-100/70 px-4 py-3 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                            </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-4">
                            <Link href="/fees" class="px-6 py-3 bg-slate-100 text-slate-700 rounded-2xl font-semibold hover:bg-slate-200 transition-all duration-200">
                                Cancel
                            </Link>
