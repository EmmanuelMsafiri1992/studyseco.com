...
const form = useForm({
    ...
    type: props.paymentMethod.type || 'mobile_money',
    region: props.paymentMethod.region || 'malawi',
    currency: props.paymentMethod.currency || 'MWK',
    instructions: props.paymentMethod.instructions || '',
    requirements: props.paymentMethod.requirements || [],
    is_active: props.paymentMethod.is_active ?? true,
    sort_order: props.paymentMethod.sort_order || 1
});
...
onMounted(() => {
    if (form.requirements.length > 0) {
        requirementsList.value = [...form.requirements];
    } else {
        addRequirement();
    }
});
...
<template>
    ...
    <DashboardLayout 
        ...
        subtitle="Modify payment method details">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-slate-200/50 overflow-hidden">
                <div class="p-6 border-b border-slate-200/50">
                    ...
                    <p class="text-sm text-slate-500 mt-1">Update the information for this payment method</p>
                </div>
