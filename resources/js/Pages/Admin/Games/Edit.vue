...
const form = useForm({
    ...
    subject_id: props.game.subject_id,
    game_type: props.game.game_type,
    max_score: props.game.max_score,
    time_limit: props.game.time_limit,
...
<template>
    <DashboardLayout title="Edit Game">
        <div class="py-6">
